...
public abstract class LoadingViewAdapter extends BaseAdapter implements SectionIndexer, OnScrollListener, Filterable {
	public static final String TAG = LoadingViewAdapter.class.getSimpleName();
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		if (view instanceof LoadingListView) {
			((LoadingListView) view).configureHeaderView(firstVisibleItem);
		}
	}
	 ...
	 * and call {@link LoadingListView#tellNoMoreData()} if there is no more pages.
	 * 
